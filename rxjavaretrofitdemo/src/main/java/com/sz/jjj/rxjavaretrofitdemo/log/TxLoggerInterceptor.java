package com.sz.jjj.rxjavaretrofitdemo.log;
...
//            String url = EncryptUtils.decryptStr(request.url().queryParameter(KEY_JSON));
            ...
            Log.e(tag, "json : " + "json=" + request.url());
...
//                                Log.e(tag, "responseBody's content : " + EncryptUtils.decryptStr(resp));
                            }
                        }
