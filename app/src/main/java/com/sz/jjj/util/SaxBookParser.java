package com.sz.jjj.util;

import com.sz.jjj.inter.BookParser;
import com.sz.jjj.model.Books;
    ...
    private class MyHandler extends DefaultHandler {
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            ...
            if (localName.equals("id")) {
                ...
                books.add(book);
            }else if(localName.equals("aa")){
                test.setAa(builder.toString());
            }else if(localName.equals("bb")){
                test.setBb(builder.toString());
            }else if(localName.equals("test")){
                book.setTest(test);
            }
        }
