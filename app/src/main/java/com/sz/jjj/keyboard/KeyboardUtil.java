...
public class KeyboardUtil {
    ...
    public KeyboardUtil(Activity activity, EditText... editTexts) {
        ...
        mNumberKeyboard = new Keyboard(mActivity, R.xml.keyboard_numbers);
        mLetterKeyboard = new Keyboard(mActivity, R.xml.keyboard_qwerty);
    ...
    private void changeKeyboart() {
        Drawable capsLock = ContextCompat.getDrawable(mActivity, R.mipmap.ic_softkey_capslock);
        Drawable unCapsLock = ContextCompat.getDrawable(mActivity, R.mipmap.ic_softkey_uncapslock);
